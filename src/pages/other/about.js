            ...
            <Row>
              <Col lg={8} className="ml-auto mr-auto">
                ...
                <div className="about-title-container text-center">
                  <p className="dark-title space-mb--35">{t("simply_or_white")}</p>
                ...
                <Row>
                  <Col md={6}>
                    <div className="about-widget space-mb--35">
                      <h2 className="widget-title space-mb--25">{t("address")}</h2>
                      <p className="widget-content">
                      {t("address_value")}
                      </p>
                    </div>
                    <div className="about-widget space-mb--35">
                      <h2 className="widget-title space-mb--25">{t("phone")}</h2>
                      <p className="widget-content">{t("mobile")}: (+389) 78 / 343 – 377</p>
                      <span>{t("phone")}: (+389) 46 / 207 – 770</span>
                    </div>
                    <div className="about-widget">
                      <h2 className="widget-title space-mb--25">{t("email")}</h2>
