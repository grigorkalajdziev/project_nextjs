...
const Contact = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  if (nameError) {
    addToast(nameError, { appearance: "error", autoDismiss: true });
    hasError = true;
  }
  ...
  if (subjectError) {
    addToast(subjectError, { appearance: "error", autoDismiss: true });
    hasError = true;
  }

  if (messageError) {
    addToast(messageError, { appearance: "error", autoDismiss: true });
    hasError = true;
  }
