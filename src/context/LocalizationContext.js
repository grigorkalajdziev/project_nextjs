...
const translations = {
  ...
  mk: {
    ...
    terms_of_service: "Услови на користење",
    tos_intro: "Добредојдовте во Kika Makeup Academy. Со пристап или користење на нашата веб-страница и услуги, се согласувате да ги почитувате овие Услови на користење. Ве молиме внимателно прочитајте ги пред да ја користите нашата платформа.",
    ...
    changes_text: "Kika Makeup Academy може да ги ажурира овие Услови на користење во секое време. Продолженото користење на нашите услуги се смета за прифаќање на ажурираните услови.",
