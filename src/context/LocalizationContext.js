...
const translations = {
  ...
  mk: {
    ...
    removed_from_wishlist: "Отстрането од листата на желби",
    removed_all_from_wishlist: "Листата на желби е исчистена", 
    item_decremented_from_cart: "Ставката е намалена во кошничка",
    removed_from_cart: "Отстрането од кошничката",
    removed_all_from_cart: "Отстрането се од кошничката",
