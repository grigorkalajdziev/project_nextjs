...
const translations = {
  ...
  mk: {
    ...
    about_us_description: "Кика Makeup and Beauty Academy е академија која ги инспирира и поддржува идните професионалци во индустријата за убавина. Нашата цел е да создадеме креативни и уверени поединци кои ќе ги освојат сите предизвици на динамичниот свет на шминкањето. Нудиме професионална обука која ги покрива како традиционалните, така и најсовремените техники на шминкање, обезбедувајќи основа за успешно градење на кариера. Со акцент на развојот на талентот и зголемувањето на самодовербата, нашата академија овозможува учениците да се подготват за влез во светот на убавината, вооружени со знаења и вештини кои се потребни за успех во оваа индустрија. За нас, секој студент е важен и работиме на тоа да им обезбедиме најдобри услови за учење, со цел да постигнат извонредност во своите кариери.",
    showing: "Прикажани",
    of: "од",
    result: "резултати",
