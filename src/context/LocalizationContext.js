...
const translations = {
  ...
  mk: {
    ...
    manage_orders: "Управувај нарачки",
    view_users: "Прегледај корисници",
    view_reports: "Прегледај извештаи",
    my_orders: "Мои нарачки",
    total_spent: "Вкупно потрошено",
    view_orders: "Прегледај нарачки",
    download_invoices: "Преземи фактури",
    ...
    selected: "Избрани",
    download_selected: "Симни избрани",
    clear_selection: "Исчисти избор",
    downloading: "Симнува",
