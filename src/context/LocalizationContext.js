...
const translations = {
  en: {
    ...
    address: "ADDRESS",
    address_details: "Bul. Turisticka 40, Ohrid - North Macedonia 6000",
    contact: "Contact",
    mobile: "Mobile",
    phone: "Phone",
    mail: "Mail",
    ...
    address: "ADDRESS",
    address_value: "Bul. Turisticka 40, Ohrid - North Macedonia 6000",
    phone: "Phone",
    mobile: "Mobile",
    email: "EMAIL",
  ...
  mk: {
    ...
    about_page_description: "Лорем ипсум долор сит амет, консектетур цинг елит. Суспе ндисе сусципит сагиттис лео сит мет цондиментум естибулум.",
    store: "ДОМА",
    ...
    email: "Е-ПОШТА",
    email_value: "contact@makeupbykika.com",
    about_page_extra_description: "Лорем ипсум долор сит амет, консектетур адиписцинг елит. Проин ац тортор нец фелис ферментум тинцidunt.",
    online_store: "онлајн продавница",
    testimonial_title: "Лични искуства",
    our_brands_title: "Брендови",
    about_us_title: "За Нас",
    about_us_description: "Во Кика Makeup and Beauty Academy, посветени сме на инспирирање на креативноста, доставување на одличност и овозможување на идни професионалци во убавината. Нашата академија нуди сеопфатна обука во безвременски техники на шминкање и современи вештини за убавина, обезбедувајќи дека нашите студенти се подготвени за успех во динамичната индустрија. Се фокусираме на развој на талентот и јакнење на самодовербата, помагајќи им на поединците да изградат трајни кариери во светот на шминкањето и убавината.",
    showing: "Прикажани",
    of: "од",
    result: "резултати",
