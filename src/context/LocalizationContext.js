...
const translations = {
  ...
  mk: {
    ...
    please_enter_your_email_first: "Ве молиме, прво внесете ја вашата е-маил.",
    ...
    please_enter_your_email: "Ве молиме, внесете ја вашата е-маил.",
    ...
    orders_payments_1: "- Сите нарачки се предмет на прифаќање и достапност.",
