...
const translations = {
  ...
  mk: {
    ...
    verify: "Верификувај",
    admin_dashboard_welcome: "Добредојдовте во вашиот администраторски панел. Тука можете да управувате со нарачки, корисници и да преглувате финансиски извештаи.",
