  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        qrCodeUrl &&
          React.createElement(Image, { style: styles.qr, src: qrCodeUrl })
      ),
      React.createElement(
        View,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                Text,
                { style: [styles.tableColHeader, styles.firstColHeader] },
                "Service"
              ),
              React.createElement(
                Text,
            ...
            normalizedProducts.map((item, idx) =>
              React.createElement(
                ...
                React.createElement(
                  Text,
                  { style: [styles.tableCol, styles.firstCol, styles.label] },
                  item.name
                ),
                React.createElement(
                  Text,
                  { style: styles.quantityCol },
                  item.quantity
                ),
                React.createElement(
                  Text,
